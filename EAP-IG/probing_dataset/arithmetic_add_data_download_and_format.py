...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate arithmetic addition dataset')
    ...
    df.to_csv(f"arithmetic_add_{args.model_name.split('/')[-1].replace('.', '')}.csv", index=False)