...
# Config
# --------------------
category  = "challenge"  # easy, challenge
INPUT_CSV  = f"arc_{category}_Llama-32-1B.csv"
MODEL      = "gpt-4o"
OUTPUT_CSV = f"arc_{category}_Llama-32-1B_{MODEL.replace('-', '')}_paraphrases_all_query.csv"
