...
parser.add_argument('--output_figure', type=str, default='figures/ioi_different_bon.pdf')
...
plt.plot(args.topns, all_best_perturb_all_var1, label=r'BoN-GP ($\sigma$=0.01)', marker='o')
plt.plot(args.topns, all_best_perturb_all_var2, label=r'BoN-GP ($\sigma$=0.001)', marker='o')
