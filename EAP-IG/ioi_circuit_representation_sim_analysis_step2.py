...
plt.tight_layout()
plt.savefig("figures/ioi/rep_heatmap.png", dpi=500, bbox_inches='tight')
...
plt.savefig("figures/ioi/rep_layer_vs_atthead_feature_distance_test.png", dpi=500, bbox_inches='tight')
...
plt.savefig("figures/ioi/rep_test22.png", dpi=500, bbox_inches='tight')
...
plt.grid(True, linestyle='--', alpha=0.6)  # Add grid for better readability
plt.xticks(range(len(std_head)), labels=std_head)  # Ensure all 12 indices are shown
plt.savefig("figures/ioi/rep_testtesttest.png", dpi=500, bbox_inches='tight')