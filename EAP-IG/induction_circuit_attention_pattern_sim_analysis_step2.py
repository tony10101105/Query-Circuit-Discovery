...
data = np.load('preprocessed_data/induction_cost_matrix_all_atthead_pattern.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig("figures/induction/pattern_heatmap.png", dpi=500, bbox_inches='tight')
...
plt.savefig("figures/induction/pattern_layer_vs_atthead_feature_distance_test.png", dpi=500, bbox_inches='tight')
...
plt.savefig("figures/induction/pattern_test22.png", dpi=500, bbox_inches='tight')
...
plt.grid(True, linestyle='--', alpha=0.6)  # Add grid for better readability
plt.xticks(range(len(std_head)), labels=std_head)  # Ensure all 12 indices are shown
plt.savefig("figures/induction/pattern_testtesttest.png", dpi=500, bbox_inches='tight')