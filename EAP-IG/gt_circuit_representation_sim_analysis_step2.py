...
plt.tight_layout()
plt.savefig("figures/gt/rep_heatmap.png", dpi=500, bbox_inches='tight')
...
plt.savefig("figures/gt/rep_layer_vs_atthead_feature_distance_test.png", dpi=500, bbox_inches='tight')
...
plt.savefig("figures/gt/rep_test22.png", dpi=500, bbox_inches='tight')
...
plt.grid(True, linestyle='--', alpha=0.6)  # Add grid for better readability
plt.xticks(range(2), labels=std_head)  # Ensure all 12 indices are shown
plt.savefig("figures/gt/rep_testtesttest.png", dpi=500, bbox_inches='tight')