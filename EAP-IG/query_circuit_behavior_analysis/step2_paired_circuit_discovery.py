...
parser.add_argument('--circuit_dir', type=str, default='query_circuit_behavior_analysis/data/paired_source_circuits')
parser.add_argument('--output_dir', type=str, default='query_circuit_behavior_analysis/data/paired_circuits')
parser.add_argument('--summary_path', type=str, default='query_circuit_behavior_analysis/data/paired_summary.json')
