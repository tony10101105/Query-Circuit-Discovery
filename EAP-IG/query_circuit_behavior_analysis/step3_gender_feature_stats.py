...
parser.add_argument('--paired_circuit_dir', type=str, default='query_circuit_behavior_analysis/data/paired_source_circuits')
parser.add_argument('--unpaired_circuit_dir', type=str, default='query_circuit_behavior_analysis/data/unpaired_circuits')
parser.add_argument('--paired_summary_path', type=str, default='query_circuit_behavior_analysis/data/paired_summary.json')
parser.add_argument('--unpaired_summary_path', type=str, default='query_circuit_behavior_analysis/data/unpaired_summary.json')
parser.add_argument('--output_dir', type=str, default='query_circuit_behavior_analysis/data/circuit_features')
parser.add_argument('--output_figure', type=str, default='query_circuit_behavior_analysis/feature_num_stats.png')
...
labels = ['Paired Best', 'Paired Worst', 'High-NDF', 'Low-NDF']
...
ax.bar(labels, means, yerr=stds, capsize=4, color=['tab:blue', 'tab:orange', 'tab:green', 'tab:red'])
ax.set_ylabel('Avg. number of gender-related SAE features')
plt.tight_layout()
