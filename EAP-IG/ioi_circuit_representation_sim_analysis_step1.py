...
results_g1, all_node_rep_g1, all_layer_rep_g1, _ = evaluate_graph(model, g1, dataloader, partial(logit_diff, loss=False, mean=False), hook_rep=True, hook_layer=True)
results_g1 = results_g1.mean().item()

results_g2, all_node_rep_g2, all_layer_rep_g2, _ = evaluate_graph(model, g2, dataloader, partial(logit_diff, loss=False, mean=False), hook_rep=True, hook_layer=True)
...
print('all_node_rep_g1: ', all_node_rep_g1.shape) # (bs, n_pos, node_num_g1, 768)
...
np.savez("preprocessed_data/ioi_cost_matrix_all_atthead_rep.npz", 
