...
class EAPDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return row['clean'], row['corrupted'], [row['label'], row['incorrect_label']]
...
all_node_pattern_g1 = all_node_pattern_g1.transpose(0, 1).cpu().numpy()  # (node_num_g1, data_num, n_pos, n_pos)
all_node_pattern_g2 = all_node_pattern_g2.transpose(0, 1).cpu().numpy()  # (node_num_g2, data_num, n_pos, n_pos)
