...
results_g1, _, _, all_node_pattern_g1 = evaluate_graph(model, g1, dataloader, partial(logit_diff, loss=False, mean=False), hook_rep=True, hook_layer=True, hook_pattern=True, induction=True)
results_g1 = results_g1.mean().item()
# results_g2, _, _, all_node_pattern_g2 = evaluate_graph(model, g2, dataloader, partial(logit_diff, loss=False, mean=False), hook_rep=True, hook_layer=True, hook_pattern=True, induction=True)
...
all_node_pattern_g2 = all_node_pattern_g1
...
### for truncation
# seq_len = 20
# all_node_pattern_g1 = all_node_pattern_g1[:, :, :seq_len, :seq_len]
# all_node_pattern_g2 = all_node_pattern_g2[:, :, :seq_len, :seq_len]
...
np.savez("preprocessed_data/induction_cost_matrix_all_atthead_pattern.npz", 
